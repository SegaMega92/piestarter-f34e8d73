    ...
    <section className="flex flex-col lg:flex-row gap-[24px] lg:gap-[30px] items-start pt-[40px] md:pt-[60px] pb-[60px] md:pb-[120px] w-full">
      ...
      >
        ...
        <div className="flex flex-col gap-[8px] w-full">
          ...
          <button className="bg-azure-13 flex items-center justify-center px-[30px] py-[14px] md:py-[18px] rounded-[30px] w-full cursor-pointer hover:bg-[#2a3040] active:scale-[0.98] transition-all">
