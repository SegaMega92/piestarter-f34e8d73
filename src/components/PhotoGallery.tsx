...
const PhotoGallery = () => {
  return (
    <section className="flex gap-[23px] items-center justify-center px-[70px]">
      {/* Main Image */}
      <div className="h-[474px] overflow-hidden rounded-[40px] w-[625px] shrink-0 cursor-pointer group">
      ...
      <div className="flex flex-wrap gap-[30px] w-[624px]">
        <div className="h-[222px] overflow-hidden rounded-[40px] w-[297px] cursor-pointer group">
        ...
        <div className="h-[222px] overflow-hidden rounded-[40px] w-[297px] relative cursor-pointer group">
