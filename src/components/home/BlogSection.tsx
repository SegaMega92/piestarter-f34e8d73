...
const blogPosts = [
  {
    ...
    title: "Нехватка офисов: спрос растёт быстрее, чем предложение",
    date: "12 Октября",
  },
  {
    id: 2,
    image: eventsCard2,
    category: "Аналитика",
    title: "Где «выстрелит» коммерческая недвижимость: регионы на старте роста",
    date: "9 Октября",
  },
  {
    id: 3,
    image: eventsCard3,
    category: "Инвестиции",
    title: "Что будет с доходностью ЗПИФов в 2026 году",
    date: "12 Октября",
  },
];
      ...
      <div className="content-container">
        ...
        <div className="flex flex-col lg:flex-row gap-[24px] lg:gap-[60px] mb-[40px] md:mb-[60px]">
          ...
          <p className="text-grey-44 text-[16px] md:text-[18px] leading-[24px] lg:flex-1 lg:pt-[16px]">
            Свежие материалы из нашего Telegram-канала. Делимся новостями, аналитикой и тем, что влияет на рынок и решения инвесторов. Если хотите следить за трендами и понимать, что происходит — присоединяйтесь
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[24px] md:gap-[30px]">
          {blogPosts.map((post, index) => (
            ...
            >
              <div
                className={`rounded-[24px] md:rounded-[40px] overflow-hidden ${
                  index === 1 ? "h-[250px] md:h-[410px]" : "h-[200px] md:h-[300px]"
                }`}
              >
                <img
                  src={post.image}
              ...
              <div className="flex flex-col gap-[8px]">
                <span className="text-grey-44 text-[14px] md:text-[16px]">
                  {post.category}
                </span>
