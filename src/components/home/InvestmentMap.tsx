      ...
      <div className="content-container mb-[40px] md:mb-[60px]">
        <div className="flex flex-col lg:flex-row gap-[24px] lg:gap-[100px]">
          <h2 className="font-semibold text-[36px] md:text-[56px] lg:text-[68px] leading-[1.05] tracking-[-1px] md:tracking-[-2px] text-white lg:w-[625px]">
            Инвестиционная температура
          </h2>
          <p className="text-grey-71 text-[16px] md:text-[18px] leading-[24px] lg:flex-1 lg:pt-[16px]">
            Карта показывает, где растёт цена на коммерческую недвижимость — и куда уже сейчас стоит присмотреться. Точками отмечены объекты, в которых можно приобрести паи.
          </p>
        </div>
      </div>
        ...
        <div className="relative rounded-[24px] md:rounded-[40px] overflow-hidden">
          ...
          <div className="relative aspect-[16/10] md:aspect-[1284/692]">
            ...
            {markers.map((marker) => (
              ...
              >
                <span className="font-semibold text-[12px] md:text-[14px] text-black">
                  {marker.count}
                </span>
              </button>
            ))}
              ...
              >
                <div className="flex items-center justify-between mb-[12px]">
                  ...
                  <button
                    ...
                    className="w-[24px] h-[24px] flex items-center justify-center text-grey-44 hover:text-black"
                  >
                    ✕
                  </button>
                </div>
                <div className="flex flex-col gap-[8px] mb-[16px]">
                  <div className="flex gap-[8px] text-[14px]">
                    ...
                    <span className="text-black">1 531 529 489 ₽</span>
                  </div>
                  <div className="flex gap-[8px] text-[14px]">
                    <span className="text-grey-44">Доходность:</span>
                    <span className="text-black">25%</span>
                  </div>
                </div>
                <a
                  href="#"
                  className="block w-full text-center py-[14px] border border-grey-88 rounded-[30px] text-[14px] font-medium text-black hover:bg-grey-96 transition-colors"
                >
                  Подробнее
                </a>
              </div>
            ...
            <div className="absolute top-[16px] right-[16px] md:top-[20px] md:right-[20px]">
              <select
                ...
                className="px-[16px] py-[8px] bg-white rounded-[20px] text-[14px] text-black border-none outline-none cursor-pointer"
              >
            ...
            <div className="absolute bottom-[16px] right-[16px] md:bottom-[20px] md:right-[20px] bg-white/90 backdrop-blur-sm rounded-[16px] p-[12px] md:p-[16px]">
              <p className="text-[10px] md:text-[12px] text-grey-44 mb-[8px]">
